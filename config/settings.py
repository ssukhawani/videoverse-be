...
ALLOWED_HOSTS = ['35.154.218.34','backend.bytegenie.tech','www.backend.bytegenie.tech', 'bytegenie.tech', 'www.bytegenie.tech', ]

CORS_ALLOWED_ORIGINS = [
     'http://35.154.218.34', 'https://backend.bytegenie.tech', 'https://bytegenie.tech', 'https://www.bytegenie.tech', 'https://www.backend.bytegenie.tech'
]
